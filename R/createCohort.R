...
#' @param cohortInfo Object create via CreateSQL_T2DM
#' @param outcomeInfo Object create via CreateSQL_T2DM_outcome
#'
...
#' cohortCounts <- createCohort(cdm_bbdd, cdm_schema, results_sc, cohortTable, cohortInfo,
#'                              outcomeInfo)
