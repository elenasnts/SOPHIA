...
buildData <- function(cdm_bbdd,
  ...
  covariateData$covariates <- dplyr::mutate(
    ...
    covariateId = dplyr::if_else(.data$covariateId %in% cancer_conceptId, , .data$covariateId),
...
transformToFlat <- function(covariateData){
  ...
  bbdd_covar <-  dplyr::mutate(
    ...
    variable = dplyr::if_else(stringr::str_sub(.data$covariateId, start = -3L) == 117, 'COPD_vars', .data$variable),
    variable = dplyr::if_else(stringr::str_sub(.data$covariateId, start = -3L) == 118, 'CKD_vars', .data$variable),
    variable = dplyr::if_else(stringr::str_sub(.data$covariateId, start = -3L) == 119, 'cancer_vars', .data$variable),
    variable = dplyr::if_else(stringr::str_sub(.data$covariateId, start = -3L) == 120, 'depress_vars', .data$variable),
    variable = dplyr::if_else(stringr::str_sub(.data$covariateId, start = -3L) == 121, 'htn_vars', .data$variable),
    variable = dplyr::if_else(stringr::str_sub(.data$covariateId, start = -3L) == 122, 'hf_vars', .data$variable),
    variable = dplyr::if_else(stringr::str_sub(.data$covariateId, start = -3L) == 123, 'liver_vars', .data$variable),
    variable = dplyr::if_else(stringr::str_sub(.data$covariateId, start = -3L) == 124, 'ra_vars', .data$variable),
    variable = dplyr::if_else(stringr::str_sub(.data$covariateId, start = -3L) == 125, 'sleep_apnea_vars', .data$variable),
    variable = dplyr::if_else(stringr::str_sub(.data$covariateId, start = -3L) == 126, 'pcos_vars', .data$variable),
